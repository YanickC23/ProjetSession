...
@Database(entities = {Client.class, Voiture.class, Location.class, Voiture_Location.class, Client_Voiture.class}, version = 2, exportSchema = false)
public abstract class LocationDB extends RoomDatabase {
    ...
    public abstract Client_Voiture client_voitureDao();
}
